...
def upgrade() -> None:
    ...
    op.create_index('ix_hq_prospective_user_nickname', 'hq_prospective_user', ['nickname'])
    op.create_index('ix_hq_prospective_user_is_joined', 'hq_prospective_user', ['is_joined'])


def downgrade() -> None:
    op.drop_index('ix_hq_prospective_user_is_joined', table_name='hq_prospective_user')
    op.drop_index('ix_hq_prospective_user_nickname', table_name='hq_prospective_user')
