"""add v2 golden retention tables

Revision ID: 20260119_1700
Revises: 20260119_1600
Create Date: 2026-01-19 17:00:00
...
revision = "20260119_1700"
down_revision = "20260119_1600"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "psychological_state",
            sa.Enum("IN_FLOW", "BORED", "FRUSTRATED", "TILTED", name="v2_retention_psych_state"),
            nullable=False,
            server_default="IN_FLOW",
        ),
        sa.Column(
            "user_segment_tag",
            sa.Enum("HIGH_ROLLER", "CASUAL_LOYAL", "NEW_USER", "CHURN_RISK", name="v2_retention_segment_tag"),
            nullable=False,
    ...
    op.create_index("ix_v2_retention_roi_log_user_id", "v2_retention_roi_log", ["user_id"])
    op.create_index("ix_v2_retention_roi_log_created_at", "v2_retention_roi_log", ["created_at"])


def downgrade() -> None:
    op.drop_index("ix_v2_retention_roi_log_created_at", table_name="v2_retention_roi_log")
    op.drop_index("ix_v2_retention_roi_log_user_id", table_name="v2_retention_roi_log")
    op.drop_table("v2_retention_roi_log")

    op.drop_table("v2_user_retention_state")