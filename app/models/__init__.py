"""Model package exports - SHIM for V1 compatibility.

All models are now defined in app.v2.models.core.
This file re-exports them for backward compatibility with V1 code.

DO NOT ADD NEW MODELS HERE. Add them to app/v2/models/ instead.
"""
# Re-export all models from V2 core
...
from app.v2.models.core.mission import Mission, UserMissionProgress, MissionCategory, ApprovalStatus, MissionRewardType, UserStreak
...
# Compatibility aliases for SeasonPass (deprecated names)
SeasonPassConfig = None  # Removed - use V2SeasonPassConfig if needed
SeasonPassLevel = None   # Removed - use V2SeasonPassLevel if needed
