...
class V2Survey(Base):
    ...
    # Keep table name for data continuity
    ...
    questions = relationship("V2SurveyQuestion", cascade="all, delete-orphan", back_populates="survey")
    triggers = relationship("V2SurveyTriggerRule", cascade="all, delete-orphan", back_populates="survey")
...
class V2SurveyQuestion(Base):
    ...
    survey = relationship("V2Survey", back_populates="questions")
    options = relationship("V2SurveyOption", cascade="all, delete-orphan", back_populates="question")


class V2SurveyOption(Base):
    ...
    question = relationship("V2SurveyQuestion", back_populates="options")
...
class V2SurveyTriggerRule(Base):
    ...
    survey = relationship("V2Survey", back_populates="triggers")
    responses = relationship("V2SurveyResponse", back_populates="trigger_rule")
...
class V2SurveyResponse(Base):
    ...
    survey = relationship("V2Survey")
    trigger_rule = relationship("V2SurveyTriggerRule", back_populates="responses")
    answers = relationship("V2SurveyResponseAnswer", cascade="all, delete-orphan", back_populates="response")
...
class V2SurveyResponseAnswer(Base):
    ...
    response = relationship("V2SurveyResponse", back_populates="answers")
    question = relationship("V2SurveyQuestion")
    option = relationship("V2SurveyOption")
