...
5) 문서/정책 SoT는 docs/를 우선한다. 문서규칙은 "C:\Users\JAVIS\ch\ch25\docs\SOT\01_V2_DOCUMENTATION_RULES.md"를 따른다.
...
2)SOT문서 경로 C:\Users\JAVIS\ch\ch25\docs\SOT 하위로 고정
정책/코드/운영 변경 시, 변경 이력과 최신화 내역을 C:\Users\JAVIS\ch\ch25\docs\SOT\{도메인}\변경로그에 기록하고 인덱스에 반영한다.
문서/코드/운영 일관성 유지한다. 
...
## 7. 채팅지침(Chat Guidelines) 적용 안내

- AI 코딩 에이전트는 docs/chat_guidelines.md의 모든 규칙을 채팅 응답에 반드시 적용한다.
- 본 지침은 .github/instructions/rule2026.instructions.md 및 learned_ 최신 규칙을 기반으로 작성됨.
- 설계/질문/코드/정책 안내 등 모든 응답에 일관성, 품질, 안전성, 최신 정책 준수 원칙을 적용한다.

### [Brainstorming 스킬 전문]
 - v1.0 (2026-01-18, 관리자): 최초 작성
 - v1.1 (2026-01-28, Copilot): chat_guidelines.md 신규 작성 및 적용 안내 추가
name: brainstorming
description: >
