...
import styles from "./SeasonProgressWidget.module.css";
...
const SeasonProgressWidget: React.FC = () => {
  ...
  const percent = atMaxLevel
    ? 100
    : Math.min(100, Math.max(0, (currentXp / safeNext) * 100));
          ...
          <div className="flex justify-between items-end mb-2">
            <div>
              ...
              <p className="text-indigo-200 text-xs font-medium">
                {atMaxLevel
                  ? "최�? ?�벨 ?�성"
                  : "Keep growing to unlock rewards"}
              </p>
            </div>
