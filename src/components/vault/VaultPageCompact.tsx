          ...
          onClick={() => {
            ...
            addToastNode(
              <div className="text-center space-y-1">
                <p>Î∞∞Î? 2ÎßåÎ???ÏßÄÍ∏âÍ???/p>
                <p>?®Ïî®ÏΩîÏù∏ ?òÎ£® 1Í∞?ÏßÄÍ∏âÍ???(ÏºÄ?¥Î∞©?¥Î≤§??Ï§ëÎ≥µ?ÅÏö©x)</p>
                <p>Ïª¥Ìè¨Ï¶??ÑÏïÑ 1ÎßåÎ???ÏßÄÍ∏âÍ???/p>
              </div>,
              { tone: "info" },
            );
          }}
        ...
        <div className="w-full flex-1 flex flex-col items-center justify-center animate-fadeIn">
          ...
          <button
            onClick={async () => {
              if (view.availableAmount < 10000) {
                addToast("ÏµúÏÜå 10,000?êÎ???Ï∂úÍ∏à Í∞Ä?•Ìï©?àÎã§.", "error");
                return;
              }
              if (!window.confirm("?ÑÏï° Ï∂úÍ∏à ?†Ï≤≠?òÏãúÍ≤†Ïäµ?àÍπå?")) return;
              tryHaptic(50);
              try {
                ...
                addToast("?†Ï≤≠ Ï§??§Î•òÍ∞Ä Î∞úÏÉù?àÏäµ?àÎã§.", "error");
              }
            }}
          ...
          >
            <img
              ...
              alt=""
            />
            <span className="drop-shadow-sm">?®Ïî®Ïπ¥Ï???Ï∂©Ï†Ñ?òÍ∏∞</span>
          </a>
        ...
        <div className="w-full flex-1 flex flex-col items-center animate-fadeIn">
          ...
          <div className="flex flex-col items-center gap-2 mb-8">
            ...
            <div className="text-xs text-emerald-300 font-bold">
              Ï∂úÍ∏à Í∞Ä?•Ïï°: {view.availableAmount.toLocaleString()}??
            </div>
          </div>
          ...
          {view.benefitsSuspended && (
            <div className="w-full max-w-xs mb-3 px-3 py-2 rounded-xl bg-red-900/20 border border-red-500/30 flex items-center gap-2">
              ...
              <span className="text-[11px] text-red-200 font-bold leading-tight">
                ?•Í∏∞ ÎØ∏Ìôú?ôÏúºÎ°??ÖÍ∏à ?ÑÍπåÏßÄ
                <br />
                Î™®Îì† ?úÌÉù???ºÏãú ?ïÏ??©Îãà??
              </span>
            </div>
          )}
