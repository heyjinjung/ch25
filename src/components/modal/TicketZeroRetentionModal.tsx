          ...
          <div className="flex flex-col items-center pt-8 pb-6 px-6">
              ...
              {hasVault ? (
                <div className="mt-3 bg-white/5 rounded-xl p-3 border border-white/5">
                  <div className="flex items-center justify-center gap-2 text-zinc-400 text-sm mb-1">
                    <Lock size={12} />
                    <span>?†Í∏¥ Í∏àÍ≥† ?îÏï°</span>
                  </div>
                  <div className="text-emerald-400 font-bold text-lg">
                    {formatWon(vaultBalance)}??
                  </div>
                </div>
              ) : (
                <p className="text-zinc-400 text-sm mt-2 leading-relaxed">
                  ÏßÄÍ∏àÏ? ?∞Ïºì???ÜÏñ¥??br />Í≤åÏûÑ???úÏûë?òÍ∏∞ ?¥Î†§?åÏöî.
                </p>
              )}
            </div>
            ...
            <div className="w-full space-y-3">
              {hasVault ? (
                ...
                >
                  {!trialEnabled ? "Ï≤¥Ìóò ?∞Ïºì Ï§ÄÎπÑÏ§ë" : isRequestingTrial ? "ÏßÄÍ∏?Ï§?.." : "Ï≤¥Ìóò ?∞Ïºì Î∞õÍ∏∞"}
                </button>
              )}
