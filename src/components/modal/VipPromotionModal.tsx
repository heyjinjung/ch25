            ...
            >
                ...
                <div className="relative pt-10 pb-6 flex flex-col items-center text-center overflow-hidden border-b border-white/5">
                    ...
                    <p className="text-white font-bold text-base leading-snug">
                        ?åÏû•?? Í∑Ä?òÎ?<br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-200 to-amber-500">ÏµúÍ≥† ?±Í∏â ?ºÏö¥ÏßÄ</span>Î°?Î™®Ïã≠?àÎã§
                    </p>
                </div>
                ...
                <div className="p-6 flex flex-col items-center gap-5">
                    ...
                    >
                        ...
                        <p className="text-[10px] text-white/30 font-medium">?úÏ¶å ?®Ïä§ ?àÎ≤®???ÅÏäπ?©Îãà??/p>
                    </motion.div>
