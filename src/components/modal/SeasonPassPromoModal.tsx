            ...
            >
                ...
                <div className="relative pt-6 pb-3 text-center px-5">
                    ...
                    <h2 className="text-lg font-black text-white leading-tight">
                        ?úÏ¶å?®Ïä§Î°?br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Ï¥àÍ≥†???àÎ≤®??</span>
                    </h2>
                </div>
                ...
                <div className="px-5 mb-4">
                    <div className="relative p-3 rounded-xl bg-white/[0.03] border border-white/5 overflow-hidden">
                        ...
                        <div className="mt-2 flex items-center gap-2 text-[10px] text-zinc-400 font-medium">
                            ...
                            <span>?®Îì§Î≥¥Îã§ <b className="text-white">3Î∞?/b> ??Îπ®Î¶¨ ?±Ïû•?©Îãà??</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-5 grid grid-cols-2 gap-2 mb-5">
                    <div className="p-2 rounded-xl bg-zinc-900 border border-zinc-800 flex flex-col items-center gap-1">
                        ...
                        <div className="text-center leading-tight">
                            <div className="text-[9px] text-zinc-500 font-bold mb-0.5">Îß§Ïùº ÏßÄÍ∏?/div>
                            <div className="text-[10px] font-bold text-white">?§Ïù¥?ÑÎ™¨????/div>
                        </div>
                    </div>
                    ...
                    <div className="p-2 rounded-xl bg-zinc-900 border border-zinc-800 flex flex-col items-center gap-1">
                        ...
                        <div className="text-center leading-tight">
                            <div className="text-[9px] text-zinc-500 font-bold mb-0.5">VIP ?úÌÉù</div>
                            <div className="text-[10px] font-bold text-white">?ÑÏö© ?ÑÎ°ú??/div>
                        </div>
                    </div>
                </div>
