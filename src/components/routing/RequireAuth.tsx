  ...
  useEffect(() => {
    ...
    telegramApi
      ...
      .then(async (response) => {
        ...
        // "?†Í∑ú/Í∏∞Ï°¥" ?êÎ≥Ñ?Ä Telegram Í∞Ä???¨Î?Í∞Ä ?ÑÎãà???∏Î???Çπ ?ÖÍ∏à ?¥Î†•(?ÖÍ∏à???ÖÍ∏à?üÏàò ?¨Î?) Í∏∞Ï??ºÎ°ú Ï≤òÎ¶¨?úÎã§.
        // Í∏∞Ï°¥?êÎäî /new-user/welcome ?ºÎ°ú Î¶¨Îã§?¥Î†â?∏Ìñà?ºÎÇò, ?¥Ï†ú??Landing ?òÏù¥ÏßÄ?êÏÑú Î™®Îã¨Î°?Ï≤òÎ¶¨?òÎ?Î°?Î¶¨Îã§?¥Î†â?∏Î? ?úÍ±∞?úÎã§.
      ...
      .catch((err) => {
        ...
        setAuthError("?îÎ†àÍ∑∏Îû® ?∏Ï¶ù???§Ìå®?àÏäµ?àÎã§. ?†Ïãú ???§Ïãú ?úÎèÑ?¥Ï£º?∏Ïöî.");
            ...
            <div className="backdrop-blur-xl bg-white/5 border border-white/10 rounded-3xl p-8 shadow-2xl relative overflow-hidden group">
              ...
              <div className="space-y-8 relative z-10">
                ...
                >
                  ...
                  <span className="text-sm">?îÎ†àÍ∑∏Îû® ?ëÏÜç</span>
                </a>
              </div>
            </div>
