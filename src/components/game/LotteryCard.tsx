...
import {
  formatRewardLine,
  isGifticonRewardType,
} from "../../utils/rewardLabel";
...
const LotteryCard: React.FC<LotteryCardProps> = React.memo(
  ({ prize, isRevealed, isScratching, onScratch }) => {
            ...
            >
              ...
              {isRevealed && prize && (
                <div className="relative z-10 w-full h-full flex flex-col items-center justify-center p-4 text-center animate-in zoom-in-90 fade-in duration-500">
                  ...
                  <div className="relative z-20 flex flex-col items-center">
                    ...
                    (Number(prize.reward_amount) === 0 &&
                      prize.reward_type.includes("POINT")) ? (
                      <>
                      ...
                      <div className="flex flex-col items-center">
                        <h2
                          className={clsx(
                            ...
                            prize.reward_type.includes("POINT") ||
                              prize.reward_type.includes("GAME_XP")
                              ? "text-2xl"
                        ...
                        {(() => {
                          ...
                          if (rawType.startsWith("PUZZLE_")) {
                            ...
                            return (
                              <div className="my-2 relative group perspective-500 animate-bounce-subtle">
                                <div
                                  className={clsx(
                                    "relative w-20 h-24 rounded-xl flex items-center justify-center text-5xl font-black shadow-2xl transform-style-3d bg-gradient-to-br from-amber-300 via-amber-500 to-amber-700 text-white shadow-amber-500/50",
                                    styles.puzzlePiece,
                                  )}
                                >
                          ...
                          const isXP = normalizedType
                            .toUpperCase()
                            .includes("GAME_XP");
                          const isGifticon =
                            isGifticonRewardType(normalizedType);
                          const colorClass = isXP
                            ? "text-blue-400"
                            : isGifticon
                              ? "text-pink-400"
                              : "text-figma-accent";
                          ...
                          return (
                            <div className="flex flex-col items-center">
                              ...
                              {rewardLine.fulfillmentHint && (
                                <div className="mt-1 text-[10px] font-black text-white/40">
                                  ({rewardLine.fulfillmentHint})
                                </div>
                              )}
                            </div>
                    ...
                    <p className="text-figma-accent text-[10px] font-black tracking-[0.3em] uppercase opacity-70">
                      {prize.reward_type === "NONE" ? "TRY AGAIN" : "���� �Ϸ�"}
                    </p>
                  </div>
                </div>
              )}
              ...
              {isRevealed && !prize && (
                <div className="flex flex-col items-center text-center p-5 animate-in zoom-in-95">
                  ...
                  <p className="mt-2 text-white/40 font-bold text-sm">
                    ���� ������ �ʾҳ׿�.
                  </p>
                </div>
              )}
