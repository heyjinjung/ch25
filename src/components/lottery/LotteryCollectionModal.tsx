...
const LotteryCollectionModal: React.FC<LotteryCollectionModalProps> = ({
    ...
    const handleCraft = async () => {
        ...
        try {
            ...
            triggerFireworks();
            setSuccessMessage("?©Í∏à?¥Ïá† ÍµêÌôò ?±Í≥µ!");
            setTimeout(() => {
            ...
            // alert("ÍµêÌôò???§Ìå®?àÏäµ?àÎã§."); // Optional: User toast
        }
    };
                    ...
                    >
                        ...
                        <div className="relative text-center mb-8 z-10">
                            ...
                            <p className="text-sm text-zinc-500 mt-2 font-medium">
                                ?ºÏ¶ê??Î™®ÏïÑ <span className="text-amber-400 font-bold underline decoration-amber-500/30 underline-offset-4">?©Í∏à?¥Ïá†</span>Î•??ÑÏÑ±?òÏÑ∏??
                            </p>
                        </div>
                        ...
                        <div className="mt-4">
                            {successMessage ? (
                                ...
                                >
                                    <p className="text-lg font-black text-amber-300">?éâ {successMessage}</p>
                                </motion.div>
                            ) : (
                                <Button
                                    onClick={handleCraft}
                                ...
                                >
                                    {isPending ? "ÍµêÌôò Ï§?.." : canCraft ? "?îë ?©Í∏à?¥Ïá† ÍµêÌôò?òÍ∏∞" : "Ï°∞Í∞Å??Î∂ÄÏ°±Ìï©?àÎã§"}
                                </Button>
                            )}
                        </div>
