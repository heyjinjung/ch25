  ...
  const connectWebSocket = () => {
    ...
    try {
      ...
      ws.onmessage = (e) => {
        try {
          ...
          if (message.type === "error") {
            console.error(`WebSocket ?¤ë¥˜: ${message.message}`);
          }
        } catch (err) {
      ...
      ws.onerror = (error) => {
        ...
        console.error("Golden ?´ë²¤???¤íŠ¸ë¦??°ê²° ?¤ë¥˜");
