...
const MODAL_TOGGLES = [
  {
    key: "attendance_streak_enabled",
    label: "출석 스트릭 모달",
    description: "연속 출석 보상 모달",
  },
  {
    key: "new_user_welcome_enabled",
    label: "신규 유저 웰컴",
    description: "신규 가입자 환영 모달",
  },
  {
    key: "starter_missions_enabled",
    label: "초보자 미션",
    description: "초보자 미션 안내 모달",
  },
  {
    key: "golden_hour_enabled",
    label: "골든아워",
    description: "골든아워 이벤트 모달",
  },
  {
    key: "vip_promo_enabled",
    label: "VIP 프로모션",
    description: "VIP 혜택 안내 모달",
  },
  {
    key: "vip_eligibility_enabled",
    label: "VIP 자격",
    description: "VIP 등급 안내 모달",
  },
  { key: "inbox_enabled", label: "수신함", description: "수신함 알림 모달" },
  {
    key: "vault_info_enabled",
    label: "볼트 정보",
    description: "볼트 시스템 설명 모달",
  },
  {
    key: "withdrawal_conditions_enabled",
    label: "출금 조건",
    description: "출금 요구사항 안내 모달",
  },
  {
    key: "withdrawal_progress_enabled",
    label: "출금 진행",
    description: "출금 진행상황 모달",
  },
  {
    key: "lottery_collection_enabled",
    label: "복권 수집",
    description: "복권 수집 현황 모달",
  },
  {
    key: "limited_offer_enabled",
    label: "한정 오퍼",
    description: "기간 한정 할인 모달",
  },
  {
    key: "season_pass_enabled",
    label: "시즌패스",
    description: "시즌 패스 광고 모달",
  },
  {
    key: "ticket_zero_enabled",
    label: "티켓 제로",
    description: "티켓 소진 안내 모달",
  },
];
    ...
    <div className="space-y-6 p-6 text-white min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {MODAL_TOGGLES.map((toggle) => {
          const isEnabled =
            (localConfig[toggle.key] ?? currentConfig[toggle.key]) !== false;
          return (
            <Card
              key={toggle.key}
            ...
            >
              ...
              <CardContent className="pt-0">
                <div className="flex items-center gap-2 text-xs">
                  ...
                  />
                  <span
                    className={isEnabled ? "text-emerald-500" : "text-red-500"}
                  >
