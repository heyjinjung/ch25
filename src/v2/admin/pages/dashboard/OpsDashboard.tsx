  ...
  return (
    <div className="p-6 space-y-8 h-full bg-[#121214] min-h-screen text-[#E4E4E7] font-sans">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-sm text-zinc-400">
            ?œìŠ¤???íƒœ, ë¦¬ìŠ¤??? ì?, ?µì‹¬ ?´ì˜ ì§€?œë? ?¤ì‹œê°„ìœ¼ë¡?ê´€?œí•©?ˆë‹¤.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        />
        <QuickActionCard
          label="ê°œë°œì¤?(Holding)"
          description={
            <div className="flex items-baseline gap-1">
              <span className="text-xs text-zinc-500">ë¦¬í…???„í™© ì¤€ë¹„ì¤‘</span>
            </div>
          }
          icon={Activity}
        ...
        <QuickActionCard
          ...
          description={
            <div className="flex items-center gap-1">
              ...
              />
              <span className="text-xs text-zinc-500">ëª?(24h)</span>
            </div>
          }
          icon={Users}
          ...
          <div className="flex justify-between items-start mb-6">
            <div>
              <h3 className="text-lg font-bold text-white flex items-center gap-2">
                ...
                ê³¨ë“  ?ˆì´??(Risk & Opportunity)
              </h3>
              <p className="text-zinc-500 text-xs">
                AIê°€ ?ì????„ê¸°/ê¸°íšŒ ? ì? ê·¸ë£¹?…ë‹ˆ??
              </p>
            </div>
            <Badge
              variant="outline"
            ...
            <Card className="bg-black/20 border-red-500/20">
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-red-400 flex items-center gap-2">
                  <PulsatingDot color="#ef4444" /> Crisis Group (?„ê¸°)
                </CardTitle>
              </CardHeader>
            ...
            <Card className="bg-black/20 border-emerald-500/20">
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-emerald-400 flex items-center gap-2">
                  <PulsatingDot color="#10b981" /> Whales (ê¸°íšŒ)
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="text-center py-8 text-zinc-500 text-sm">
                  {status?.goldenRadar?.highRollers > 0
                    ? `${status.goldenRadar.highRollers}ëª…ì˜ ê³ ì•¡ ? ì? ?œì„±`
                    : "?œì„± ê³ ì•¡ ?¬ìš©???†ìŒ"}
                </div>
              </CardContent>
            </Card>
          ...
          <div className="space-y-4 overflow-y-auto pr-2">
            ...
            <div className="p-3 rounded-lg bg-zinc-800/50 border border-white/5 text-sm">
              <div className="flex justify-between mb-1">
                <span className="font-bold text-zinc-400">?œìŠ¤??ë°±ì—…</span>
                <span className="text-xs text-zinc-500">1h ago</span>
              </div>
              <p className="text-zinc-500">
                ?•ê¸° ?°ì´?°ë² ?´ìŠ¤ ë°±ì—…???„ë£Œ?˜ì—ˆ?µë‹ˆ??
              </p>
            </div>
          </div>
        </div>
