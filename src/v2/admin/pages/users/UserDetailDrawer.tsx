            ...
            <SheetHeader className="px-6 py-4 border-b border-white/5 bg-[#18181B] sticky top-0 z-10">
              <div className="flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <Button
                    variant={
                      user.benefitsSuspendedManual ? "default" : "outline"
                    }
                    size="sm"
                    className={
                      user.benefitsSuspendedManual
                    ...
                    onClick={async () => {
                      if (
                        confirm(
                          `정말 이 유저의 혜택을 ${user.benefitsSuspendedManual ? "해제" : "제재"}하시겠습니까?`,
                        )
                      ) {
                        try {
