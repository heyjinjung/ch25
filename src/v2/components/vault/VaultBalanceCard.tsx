...
export const VaultBalanceCard: React.FC<VaultBalanceCardProps> = ({
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-black/85 to-slate-900/90 p-8 shadow-2xl backdrop-blur-2xl border border-white/10">
      {/* Glow Effect */}
      ...
      <div className="relative z-10 flex flex-col items-center text-center">
        ...
        >
          <img
            src="/assets/vault/vault_init.png" 
            alt="Vault"
            className="w-48 h-48 object-contain drop-shadow-[0_0_35px_rgba(212,175,55,0.5)]"
          />
        </motion.div>
