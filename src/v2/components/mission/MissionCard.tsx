      ...
      <div className="relative z-10 flex flex-col gap-4">
        ...
        <div className="flex justify-between items-start">
          ...
          <div className="flex items-center gap-1.5 px-3 py-1.5 bg-zinc-900/50 rounded-xl border border-white/5 shadow-inner">
              <Gift className={cn("w-3.5 h-3.5", isClaimable ? "text-yellow-400 animate-bounce" : "text-zinc-500")} />
              <div className="flex flex-col">
                <span className="text-[10px] text-zinc-600 font-bold leading-none uppercase tracking-tighter">Reward</span>
        ...
        <div className="flex items-center justify-between gap-4 mt-2">
          ...
          <div className="flex-1 space-y-2">
            <div className="flex justify-between text-[10px] font-bold px-1 uppercase tracking-tight">
              <span className={cn(percent >= 100 ? "text-emerald-500" : "text-zinc-600")}>
