...
import { X, CheckCircle2, Clock, Gift, Users, CreditCard, Sparkles, Loader2 } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col items-center text-center">
        ...
        <h2 className="text-2xl font-black text-white italic mb-1">연속출석 보너스</h2>
        ...
        return (
          <div className="space-y-6">
             <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl font-black text-white italic mb-2">골든아워 이벤</h2>
        ...
        return (
          <div className="space-y-6">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl font-black text-white italic mb-2">신규유저 웰컴팩</h2>
              <p className="text-[13px] text-white/50 px-4 leading-relaxed">가입 후 <span className="text-emerald-500 font-bold">168시간(7일)</span> 동안만 제공되는<br/>신규 회원 전용 특별 미션 패키지입니다.</p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-2.5">
               {[
                 ...
                 { t: "텔레그램 공식채널 가입", b: "1만원 상당 기프티콘", icon: "📱" }
               ].map((step, i) => (
                 <div key={i} className="flex items-center gap-4 p-4 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors">
                    ...
                    <div className="flex-1">
                       ...
                       <div className="text-[11px] font-black text-emerald-500/80">{step.b} 지급</div>
                    </div>
                    <div className="text-[10px] font-black text-white/20 uppercase tracking-tighter">STEP 0{i+1}</div>
                 </div>
               ))}
            </div>
          </div>
        ...
        return (
          <div className="space-y-6">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl font-black text-white italic mb-1">입금반영이 늦나요?</h2>
              <p className="text-[13px] text-zinc-400 px-6 leading-relaxed">기다리게 해서 죄송해요! 코드지갑에서 입금반영이 늦어질 경우,<br/>즐겁게 게임하시라고 보너스를 드립니다.</p>
            </div>
            ...
            <div className="bg-blue-500/5 rounded-[40px] p-8 border border-blue-500/10 text-center relative overflow-hidden">
               ...
               <h3 className="text-xs font-black text-blue-500/80 uppercase tracking-widest mb-4">지연보상 선물</h3>
               <div className="inline-flex items-center gap-3 py-3 px-8 rounded-full bg-blue-500/10 border border-blue-500/20 mb-6 group hover:scale-105 transition-transform">
                  ...
                  <span className="text-2xl font-black text-white tracking-tighter">룰렛 티켓 3장</span>
               </div>
               <div className="space-y-2">
                  <p className="text-[12px] font-bold text-white/90">입금 신청후 30분이 지났다면?</p>
                  <p className="text-[11px] text-white/40 leading-relaxed">지민이한테 살짝 말씀해주세요.<br/>확인 후  반영해 드릴게요!</p>
               </div>
            </div>
          </div>
        );
        ...
        return (
          <div className="space-y-6">
            <div className="flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl font-black text-white italic mb-2">팀배틀 이벤</h2>
