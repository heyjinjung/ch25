...
const V2MobileBottomNav: React.FC = memo(() => {
  ...
  const isHomeActive = () => currentPath === "/v2" || isActive("/v2/home");
  ...
  const navItems = [
    ...
    },
    {
      label: "게임",
      to: "/v2/game",
      isActive: isActive("/v2/game") || isActive("/v2/team-battle"),
      dataTour: "nav-games",
      icon: (active: boolean) => (
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
      label: "금고",
      to: "/v2/vault",
      isActive: currentPath.startsWith("/v2/vault"),
      dataTour: "nav-vault",
      icon: (active: boolean) => (
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
      label: "교환소",
      to: "/v2/shop",
      isActive: currentPath.startsWith("/v2/shop"),
      dataTour: "nav-shop",
      icon: (active: boolean) => (
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
      ...
      isActive:
        ...
        currentPath.startsWith("/season-pass") ||
      ...
      icon: (active: boolean) => (
        <div className="relative">
          <svg
            ...
            className={clsx(
              "w-6 h-6 mb-1 transition-transform",
              active ? "scale-110 text-amber-400" : "opacity-60",
            )}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
  ...
  return (
    <nav className="shrink-0 h-[calc(64px+env(safe-area-inset-bottom))] pb-[env(safe-area-inset-bottom)] z-[9999] bg-black/80 backdrop-blur-xl border-t border-white/5 lg:hidden">
        ...
        {navItems.map((item) => (
          <Link
            ...
            className={clsx(
              ...
              item.isActive
                ? "text-[var(--figma-accent-green)] drop-shadow-[0_0_8px_rgba(48,255,117,0.5)] font-bold"
...
V2MobileBottomNav.displayName = "V2MobileBottomNav";
