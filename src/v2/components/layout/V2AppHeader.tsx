...
const V2AppHeader: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {segment === "whale" && (
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(34,211,238,0.05),transparent)] animate-pulse pointer-events-none" />
      )}
      ...
      <div className="flex flex-col gap-2 w-full relative z-10">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-[14px] font-black text-white/90 tracking-tight">
                  {user?.telegram_username || user?.nickname || "?¬ìš©??}
                </span>
              </div>
        ...
        <div className="flex items-center justify-between gap-3 w-full h-10 px-0.5">
          <div className="flex-1 flex items-center justify-between bg-zinc-900/80 rounded-lg h-9 px-3 border border-white/5 shadow-inner">
            <div className="flex items-center gap-2">
              <img
                ...
                className="w-[18px] h-[18px] object-contain drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]"
                alt="coin"
              />
            ...
            <span className="text-[14px] font-black text-yellow-400 drop-shadow-sm font-mono tracking-tight">
          ...
          <div className="flex-1 flex items-center justify-between bg-zinc-900/80 rounded-lg h-9 px-3 border border-white/5 shadow-inner">
            ...
            <span className="text-[14px] font-black text-[#25AD82] drop-shadow-sm font-mono tracking-tight">
