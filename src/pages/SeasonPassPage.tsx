...
const SeasonPassPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (claimedLevels.length > lastClaimCountRef.current) {
      ...
      if (latest) addToast(`���� ${latest.level} ���� ����`, "info");
    }
  ...
  const seasonLevelSummary = useMemo(() => {
    if (season.isPending)
      return { title: "LV.--", detail: "���� �ҷ����� ��", progressPct: 0 };
    if (season.isError || !season.data)
      return { title: "LV.ERR", detail: "������ �ε� ����", progressPct: 0 };
    ...
    return {
      ...
      detail: `${remaining.toLocaleString()} XP ����`,
      progressPct,
    };
  ...
  const cards = [
    {
      ...
      status: external?.rank
        ? `���� ${external.rank}��${top10Needed > 0 ? `, ${top10Needed}�� UP �ʿ�` : " (�Ϸ�)"}`
        : "��ŷ ����",
    },
    {
      icon: "??",
      title: "���� �⼮ �÷���",
      desc: "���� �÷��� �� ���̾� ����",
      status: playDone ? "�Ϸ�" : "�̿Ϸ�",
    },
    {
      icon: "??",
      title: "�Ա� �̼�",
      desc: "10���� �޼����� XP �뷮 ����",
      status: `${formatCurrency(depositRemainder)}�� ����`,
    },
    {
      icon: "??",
      title: "���� �¸� 50ȸ",
