    ...
    if (season.isPending) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
                ...
                <p className="text-white/60 text-sm">?àÎ≤® ?ïÎ≥¥ Î°úÎî© Ï§?..</p>
            </div>
        );
    }
            ...
            <div className="mt-4 w-full max-w-sm mx-auto">
                ...
                {missionsOpen && (
                    <div className="mt-2 rounded-xl border border-white/10 bg-white/5 p-4 space-y-3 animate-fade-in">
                        ...
                        >
                            ...
                            <div className="min-w-0 flex-1">
                                <div className="flex items-center gap-2">
                                    <p className="text-sm font-black text-white">CC?¥Îèô</p>
                                    <span className="text-[10px] font-bold text-white/30">(?∏Î? Ï∂©Ï†Ñ)</span>
                                </div>
                                <p className="text-xs font-semibold text-white/60">10ÎßåÏõê??+20 XP</p>
                            </div>
                        </button>
                        ...
                        >
                            <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-black/30">
                                <span className="text-xl">?éÅ</span>
                            </div>
                            <div className="min-w-0 flex-1">
                                <p className="text-sm font-black text-white">?¥Î≤§??Ï∞∏Ïó¨</p>
                                <p className="text-xs font-semibold text-white/60">ÏßÄÎØ?Í≥µÏ?Ï±ÑÎÑê</p>
                            </div>
                        </button>
                    </div>
                )}
