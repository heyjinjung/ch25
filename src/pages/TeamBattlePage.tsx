...
const BATTLE_GAMES: GameOption[] = [
  { id: "dice", name: "Dice Battle", desc: "Ï£ºÏÇ¨?ÑÎ°ú ?πÎ??òÏÑ∏??, path: "/dice", icon: ICON_DICE, points: 10 },
  { id: "roulette", name: "Roulette", desc: "?úÎ∞© ?πÎ? Î£∞Î†õ", path: "/roulette", icon: ICON_ROULETTE, points: 10 },
  { id: "lottery", name: "Lottery", desc: "Îß§Ïùº ?ÄÎ∞?Í∏∞Ìöå", path: "/lottery", icon: ICON_LOTTERY, points: 10 },
];
