...
export const REWARD_TYPES = [
  ...
  // --- Keys & Premium (V2 Standard) ---
  {
    ...
    label: "골드 ???�켓 (GOLD_KEY_TICKET)",
    group: "Key",
  },
  {
    value: "DIAMOND_TICKET",
    label: "?�이???�켓 (DIAMOND_TICKET)",
    group: "Key",
  },
  ...
  {
    value: "GIFTICON_BAEMIN",
    label: "배�? ?�품�?(GIFTICON_BAEMIN)",
    group: "Gifticon",
  },
  {
    value: "GIFTICON_COMPOSE",
    label: "컴포�?커피 (GIFTICON_COMPOSE)",
    group: "Gifticon",
  },
  {
    value: "CC_COIN_GIFTICON",
    label: "씨씨코인 교환권 (CC_COIN_GIFTICON)",
    group: "Gifticon",
  },
  ...
  // --- Puzzle Collections (C1+C2+J+M = GOLD_KEY) ---
  { value: "PUZZLE_C1", label: "퍼즐 C1 (PUZZLE_C1)", group: "Collection" },
  { value: "PUZZLE_C2", label: "퍼즐 C2 (PUZZLE_C2)", group: "Collection" },
  { value: "PUZZLE_J", label: "퍼즐 J (PUZZLE_J)", group: "Collection" },
  { value: "PUZZLE_M", label: "퍼즐 M (PUZZLE_M)", group: "Collection" },
  // DEPRECATED: { value: "PUZZLE_C", label: "퍼즐 C (DEPRECATED)", group: "Collection" },
