      ...
      <div className="flex-1 overflow-auto custom-scrollbar">
        <table className="w-full text-left border-collapse">
          <thead className="sticky top-0 bg-admin-bg/90 backdrop-blur-sm z-10 border-b border-admin-border">
            <tr>
              <th className="p-4 text-xs font-bold text-admin-text-secondary uppercase">Time</th>
              <th className="p-4 text-xs font-bold text-admin-text-secondary uppercase">Category</th>
              <th className="p-4 text-xs font-bold text-admin-text-secondary uppercase">Action</th>
              <th className="p-4 text-xs font-bold text-admin-text-secondary uppercase">Target</th>
              <th className="p-4 text-xs font-bold text-admin-text-secondary uppercase">Details</th>
            </tr>
          </thead>
