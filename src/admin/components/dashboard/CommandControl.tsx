        ...
        <div className="flex flex-col h-full space-y-4 font-sans">
            ...
            <div className="admin-card p-6">
                <div className="flex items-center justify-between mb-4">
                    <h4 className="text-admin-subtitle text-admin-text-primary select-none">시스템 상태</h4>
                    <button
                        type="button"
                ...
                <div className="space-y-4">
                    <div className="flex items-center justify-between">
                        <span className="text-admin-body text-admin-text-secondary">API 상태</span>
                        {healthError ? (
                    ...
                    <div className="flex items-center justify-between">
                        <span className="text-admin-body text-admin-text-secondary">새로고침</span>
                        <div className="text-admin-meta text-admin-text-secondary">필요할 때 버튼으로 즉시 갱신하세요.</div>
                    </div>
                </div>
            </div>
            ...
            <div className="admin-card p-6 flex flex-col">
                <div className="flex items-center justify-between mb-4">
                    <h4 className="text-admin-subtitle text-admin-text-primary select-none">운영 명령</h4>
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    <p className="text-admin-body font-bold text-admin-text-primary group-hover:text-admin-text-primary">이탈 방지 알림</p>
                                    <p className="text-admin-meta text-admin-text-secondary">이탈 위험군에 알림 요청</p>
                                </div>
                            </div>
                    ...
                    <div className="group relative">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div className="text-left">
                                    <p className="text-admin-body font-bold text-admin-text-primary group-hover:text-admin-text-primary">골든 아워</p>
                                    <p className="text-admin-meta text-admin-text-secondary">운영 로그에서 계획/배율 기록</p>
                                </div>
                            </div>
                            <span className="text-[10px] border border-admin-border text-admin-text-secondary px-1.5 py-0.5 rounded font-mono">이동</span>
                        </Link>
                    </div>
                </div>
                ...
                <div className="mt-6 pt-4 border-t border-admin-border space-y-3">
                    <div className="flex items-center justify-between">
                        <p className="text-admin-meta font-bold tracking-wider text-admin-text-secondary">빠른 운영 기록</p>
                        <Link
                            to="/admin/ops"
                ...
                <div className="mt-6 space-y-3 pt-4 border-t border-admin-border">
                    <p className="text-admin-meta font-bold text-admin-danger tracking-wider">위험 구역</p>
                    <button
                        disabled
