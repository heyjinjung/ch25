      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
        <div className="space-y-1">
          <div className="flex items-center gap-2 text-zinc-500 text-xs font-medium">
            ...
            <span className="text-zinc-300">?§Ìä∏Î¶?Î≥¥ÏÉÅ</span>
          </div>
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <div className="flex-1 space-y-3">
                    <div className="flex items-center justify-between">
                      <p className="text-sm font-semibold text-zinc-300">ÏßÄÍ∏?Î≥¥ÏÉÅ (Grants)</p>
                        ...
                        <div key={gIdx} className="flex flex-wrap items-center gap-2 bg-zinc-900/50 p-2 rounded-lg border border-zinc-800 group/grant">
                          <div className="flex-1 flex items-center gap-2 min-w-[200px]">
                            {g.kind === "WALLET" ? (
                              ...
                              >
                                <option value="ROULETTE_COIN">?™ô Roulette Coin</option>
                                <option value="DICE_TOKEN">?é≤ Dice Token</option>
                                <option value="LOTTERY_TICKET">?éüÔ∏?Lottery Ticket</option>
                                <option value="GOLD_KEY">?îë Gold Key</option>
                                <option value="DIAMOND_KEY">?íé Diamond Key</option>
                                <option value="DIAMOND">?í† Diamond</option>
                              </select>
                            ) : (
                              <input
                  ...
                  <div className="w-full md:w-24 flex md:flex-col justify-between items-end gap-2 text-sm font-bold">
                    <label className="flex items-center gap-2 cursor-pointer group">
                      <span className={rule.enabled ? 'text-emerald-400' : 'text-zinc-500'}>{rule.enabled ? '?úÏÑ±' : 'ÎπÑÌôú??}</span>
                      <input
                        type="checkbox"
          ...
          <div className="admin-card p-4 space-y-4">
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-zinc-500 uppercase">?¨Ïö©??ID</label>
                  <input
                    value={userId}
                ...
                <div className="space-y-1">
                  <label className="text-[10px] font-bold text-zinc-500 uppercase">ÏµúÎ? Í≤∞Í≥º</label>
                  <input
                    type="number"
                    value={limit}
              ...
              <div className="space-y-1">
                <label className="text-[10px] font-bold text-zinc-500 uppercase">Ï°∞Ìöå ?Ä???†Ïßú</label>
                <input
                  type="date"
                  value={filterDay}
        ...
        <div className="admin-card overflow-hidden">
          <div className="p-4 border-b border-zinc-800 flex items-center justify-between bg-zinc-900/50">
            <h2 className="text-sm font-black text-white uppercase tracking-wider flex items-center gap-2">
              ...
              ÏµúÍ∑º Î∞úÏÉù ?¥Î≤§??(Recent User Events)
            </h2>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-zinc-800">
              <thead className="bg-zinc-900">
                <tr>
                  <th className="px-4 py-3 text-left text-[10px] font-bold text-zinc-500 uppercase tracking-widest">?ºÏãú (KST)</th>
                  <th className="px-4 py-3 text-left text-[10px] font-bold text-zinc-500 uppercase tracking-widest">?¥Î≤§?∏Î™Ö</th>
                  <th className="px-4 py-3 text-left text-[10px] font-bold text-zinc-500 uppercase tracking-widest">Î©îÌ? ?∞Ïù¥??/th>
                </tr>
              </thead>
              <tbody className="divide-y divide-zinc-800/50">
                ...
                {userEventsQuery.data?.items.length === 0 && (
                  <tr>
                    <td colSpan={3} className="px-4 py-8 text-center text-xs text-zinc-600">Ï°∞Ìöå???¥Î≤§?∏Í? ?ÜÏäµ?àÎã§.</td>
                  </tr>
                )}
              </tbody>
            </table>
