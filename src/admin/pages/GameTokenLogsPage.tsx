    ...
    <section className="admin-page-container space-y-10 pb-20">
      <header className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        <div className="space-y-1">
          ...
          <h1 className="text-admin-title text-admin-text-primary">?†ÌÅ∞ ?∏Îûú??Öò ?ÑÏ†Å</h1>
          <p className="text-admin-body text-admin-text-secondary font-medium">
            Î™®Îì† ?†ÌÅ∞ ÏßÄÍ∞??îÏï°, Í≤åÏûÑ ?åÎ†à??Í∏∞Î°ù Î∞??êÏû• ?∞Ïù¥?∞Î? ?§ÏãúÍ∞ÑÏúºÎ°?Ï°∞Ìöå?©Îãà??
          </p>
        </div>
        <button
      ...
      <div className="flex gap-2 p-1 bg-admin-sidebar/50 rounded-xl border border-admin-border overflow-x-auto">
        ...
        >
          <Wallet className="h-3.5 w-3.5" /> ÏßÄÍ∞??îÏï°
        </button>
        <button
        ...
        >
          <ScrollText className="h-3.5 w-3.5" /> Í≤åÏûÑ ?åÎ†à???ÑÏ†Å
        </button>
        <button
        ...
        >
          <History className="h-3.5 w-3.5" /> ?êÏû• Í∏∞Î°ù
        </button>
      </div>
      ...
      <div className="admin-card-premium p-6 flex flex-col md:flex-row gap-4">
        ...
        {activeTab === "wallets" && (
          ...
          >
            ...
            <option value="ROULETTE_COIN">Î£∞Î†õ ÏΩîÏù∏</option>
            <option value="DICE_TOKEN">Ï£ºÏÇ¨???†ÌÅ∞</option>
            <option value="LOTTERY_TICKET">Î≥µÍ∂å ?∞Ïºì</option>
            <option value="GOLD_KEY">Í≥®Îìú ??/option>
            <option value="DIAMOND_KEY">?§Ïù¥?ÑÎ™¨????/option>
          </select>
        )}
      </div>
