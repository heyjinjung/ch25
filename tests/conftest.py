...
from app.api.deps import get_db, get_current_user_id, get_current_admin_id, get_current_admin_info
...
def client() -> Generator[TestClient, None, None]:
    ...
    app.dependency_overrides[get_current_admin_info] = lambda: (1, "ADMIN")
