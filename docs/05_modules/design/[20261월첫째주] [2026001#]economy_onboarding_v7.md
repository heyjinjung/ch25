...
- v5: 데일리 미션 시스템: [docs/archive/202601/design/archive/2026!!daily_mission_system_ko_v5.md](docs/archive/202601/design/archive/2026!!daily_mission_system_ko_v5.md)
- v6: 통합 경제/성장 마스터: [docs/archive/202601/design/archive/2026!!unified_economy_and_progression_ko.md](docs/archive/202601/design/archive/2026!!unified_economy_and_progression_ko.md)

추가 설계(인벤/바우처 v1):
- [docs/archive/202601/design/archive/2026!!inventory_voucher_system_ko.md](docs/archive/202601/design/archive/2026!!inventory_voucher_system_ko.md)

추가 트러블슈팅/QA 리포트:
- [docs/08_changelog/20260101_bugfixes_and_qa.md](docs/08_changelog/20260101_bugfixes_and_qa.md)
