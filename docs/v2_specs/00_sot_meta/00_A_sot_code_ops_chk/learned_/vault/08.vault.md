...
- [x] **VaultLedger 우회 경로 수정** (2026-02-04 완료): vault2_service.py, rollback_service.py, user_routes.py 4개 경로 패치 완료
      → 관련 문서: [20260204_vault_ledger_bypass_critical_fix.md](./20260204_vault_ledger_bypass_critical_fix.md)
#
...existing code...
...
- 2026-02-04: 보상 적립 경로 VaultLedger 기록 통합 (문서: 20260204_vault_ledger_reward_alignment.md)
