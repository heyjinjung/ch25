...
| :--- | :--- | :--- | :--- | :--- | :--- |
| 환전(출금) | Withdraw | `vault_withdrawal_request` | **[조건]**<br>1) 당일 `cc_deposit` 1만 이상 (순증)<br>2) 당일 상점 1만 포인트 사용<br>3) 3일간 V2 게임 30회 이용<br>4) 회차별 최소 금액 조건 충족<br>(정책 상세: [강력한 금고 정책 SoT](v2_strict_vault_policy_sot_ko.md#31-출금-자격-withdrawal-eligibility)) | **[회차별 최소 금액]**<br>1회: 1만 / 2회: 1만<br>3회: 3만 / 4회: 5만 |
