...
| :--- | :--- | :--- | :--- |
| **NEW** | 15회 | 5,000원 | 가입 7일 이내 |
| **COMMON** | 30회 | **10,000원** | 일반 유저 |
| **VIP** | **15회** | **5,000원** | 우수 유저 (완화됨) |
| **WHALE** | **0회** | **0원** | 최우수 유저 (면제) |
| **AT_RISK** | 100회 | **30,000원** | 위험 유저 (강화됨) |

- **최근 3일 기준**: Asia/Seoul, 오전 9시 리셋(Operational Day) 정책을 따른다.
- WHALE은 플레이/소비 조건이 면제(0/0)되나, **당일 실질 입금 조건은 유지**된다.
