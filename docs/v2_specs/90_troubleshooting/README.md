...
| LEVEL | [W06_LEVEL_troubleshooting.md](./W06_LEVEL_troubleshooting.md) | **2** |
...
- [Reward Service 리팩토링 및 테스트 초기화 (02-04)](./20260204_reward_service_refactor_and_test_reset.md) - V2 네이티브 보상 서비스 전환 및 테스트 파일 정리
