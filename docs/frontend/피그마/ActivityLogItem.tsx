...
import type { MissionType } from './VaultCard';
...
export default function ActivityLogItem({ log }: ActivityLogItemProps) {
  const getActivityIcon = (type: MissionType) => {
    switch (type) {
      case 'roulette':
        return (
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
            <path fillRule="evenodd" d="M2.24 6.8a1 1 0 0 0-1.96.4l1 5a1 1 0 0 0 .98.8H6v1a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1v-1h4.52l1.33-4H11.8a.8.8 0 0 1-.77-.6l-1.01-3.04a.8.8 0 0 0-.76-.56H6.59a.8.8 0 0 0-.76.56l-.22.66a1 1 0 1 0 1.9.62l.11-.32h1.67l.68 2.04H3.24l-.99-1.4a1 1 0 0 0-1.67 1.11L2.24 6.8ZM14 14a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM7 15a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z" clipRule="evenodd" />
          </svg>
        );
      case 'teamBattle':
        return (
